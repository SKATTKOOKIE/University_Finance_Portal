 ...
 * @param string $activePage - The current active page (home, about, transactions)
        ...
        <?php if ($isLoggedIn): ?>
            <div class="navbar-links">
                ...
                <div class="nav-links-container" id="navLinksContainer">
                    ...
                    <a href="transactionsPage.php" class="nav-link <?php echo ($activePage === 'transactions') ? 'active' : ''; ?>">Transactions</a>
                </div>
